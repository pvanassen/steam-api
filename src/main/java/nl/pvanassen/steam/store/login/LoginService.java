...
public interface LoginService {
     ...
     * @param user Username
     * @param password Password
     * @param emailSteamId The email steam id
     * @param friendlyName Friendly name for this session
     * @param code Code send by email
     * @throws VerificationException In case login failed
     * @throws SteamGuardException In case a code is requested
     * @throws CapchaException In case a capcha needs to be solved
     */
     ...
     * @throws CapchaException In case a capcha needs to be solved
     */
    void login(String user, String password, String capchaGid, String capchaAnswer, String emailSteamId, String friendlyName, String code) throws VerificationException, SteamGuardException; 
}
