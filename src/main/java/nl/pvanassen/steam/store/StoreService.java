...
public interface StoreService {
     ...
     *
     * @param username
     *            The username to get the inventory from
     * @return List of items in the inventory
     */
     ...
     *
     * @param appId
     *            Appid of the item to get
     * @param urlName
     *            url name of the item to get
     * @param dataPointHandle
     *            If a datapoint is found this handle is called
     * @param listingHandle
     *            If all datapoints have been processed, the listings are
