...
public class Purchase extends HistoryRow {
	...
	Purchase(String rowName, int appId, String urlName, int contextId,
	...
	public String toString() {
		return "Purchase [item=" + item + ", contextId=" + contextId
				+ ", seller=" + seller + ", getRowName()=" + getRowName()
				+ ", getListed()=" + getListed() + ", getActed()=" + getActed()
				+ ", getPrice()=" + getPrice() + "]";
	}
